...
export function Button({
  ...
  const base =
    "inline-flex items-center justify-center font-display uppercase tracking-wider transition-all duration-fast ease-out-quart focus-visible:outline-[3px] focus-visible:outline-brand focus-visible:outline-offset-[3px]";
